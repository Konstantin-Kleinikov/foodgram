# Generated by Django 4.2.23 on 2025-07-29 20:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=150, unique=True, validators=[recipes.validators.username_validator], verbose_name='Никнейм пользователя')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Введите название тега (до 32 символов)', max_length=32, unique=True, verbose_name='Наименование')),
        ...
        migrations.AddIndex(
            model_name='follow',
            index=models.Index(fields=['user', 'following'], name='recipes_fol_user_id_3b41e3_idx'),
        ),
        migrations.AddConstraint(
            model_name='follow',
